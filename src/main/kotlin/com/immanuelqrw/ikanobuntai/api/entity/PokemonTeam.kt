...
import com.immanuelqrw.ikanobuntai.api.dto.output.PokemonTeam as PokemonTeamOutput
...
data class PokemonTeam(
    ...
    val output: PokemonTeamOutput
        get() {
            return PokemonTeamOutput(
                trainerTeam = trainerTeam.output,
