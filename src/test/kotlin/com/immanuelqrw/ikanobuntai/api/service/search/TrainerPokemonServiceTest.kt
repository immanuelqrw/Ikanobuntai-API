...
/**
 * Unit tests for TrainerPokemonService
 */
@ExtendWith(SpringExtension::class)
@TestInstance(TestInstance.Lifecycle.PER_CLASS)
class TrainerPokemonServiceTest : BaseUniqueServiceTest<TrainerPokemon>() {

    override val classType: Class<TrainerPokemon> = TrainerPokemon::class.java

    @InjectMocks
    override lateinit var service: TrainerPokemonService

    @Mock
    override lateinit var repository: BaseUniqueRepository<TrainerPokemon>

    @Mock
    override lateinit var searchService: SearchService<TrainerPokemon>

    override val validId: UUID = UUID.randomUUID()
    override val invalidId: UUID = UUID.randomUUID() // ! Need method of failing

    @Mock
    override lateinit var validEntity: TrainerPokemon

    @Mock
    override lateinit var invalidEntity: TrainerPokemon

    @Mock
    override lateinit var replacedEntity: TrainerPokemon
    ...
    @Mock
    override lateinit var invalidSearchSpecification: Specification<TrainerPokemon>
