...
/**
 * Unit tests for NatureService
 */
@ExtendWith(SpringExtension::class)
@TestInstance(TestInstance.Lifecycle.PER_CLASS)
class NatureServiceTest : BaseUniqueServiceTest<Nature>() {

    override val classType: Class<Nature> = Nature::class.java

    @InjectMocks
    override lateinit var service: NatureService

    @Mock
    override lateinit var repository: BaseUniqueRepository<Nature>

    @Mock
    override lateinit var searchService: SearchService<Nature>

    override val validId: UUID = UUID.randomUUID()
    override val invalidId: UUID = UUID.randomUUID() // ! Need method of failing

    @Mock
    override lateinit var validEntity: Nature

    @Mock
    override lateinit var invalidEntity: Nature

    @Mock
    override lateinit var replacedEntity: Nature
    ...
    @Mock
    override lateinit var validPage: Page<Nature>

    override val validSearch: String = "id:$validId"
    override val invalidSearch: String = "id@$validId"

    @Mock
    override lateinit var validSearchSpecification: Specification<Nature>

    @Mock
    override lateinit var invalidSearchSpecification: Specification<Nature>
