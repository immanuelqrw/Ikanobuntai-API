...
/**
 * Unit tests for TrainerService
 */
@ExtendWith(SpringExtension::class)
@TestInstance(TestInstance.Lifecycle.PER_CLASS)
class TrainerServiceTest : BaseUniqueServiceTest<Trainer>() {

    override val classType: Class<Trainer> = Trainer::class.java

    @InjectMocks
    override lateinit var service: TrainerService

    @Mock
    override lateinit var repository: BaseUniqueRepository<Trainer>

    @Mock
    override lateinit var searchService: SearchService<Trainer>

    override val validId: UUID = UUID.randomUUID()
    override val invalidId: UUID = UUID.randomUUID() // ! Need method of failing

    @Mock
    override lateinit var validEntity: Trainer

    @Mock
    override lateinit var invalidEntity: Trainer

    @Mock
    override lateinit var replacedEntity: Trainer
    ...
    @Mock
    override lateinit var validPage: Page<Trainer>

    @Mock
    override lateinit var validEntities: List<Trainer>
    ...
    @Mock
    override lateinit var validSearchSpecification: Specification<Trainer>

    @Mock
    override lateinit var invalidSearchSpecification: Specification<Trainer>
