...
/**
 * Unit tests for ScheduledBattleService
 */
@ExtendWith(SpringExtension::class)
@TestInstance(TestInstance.Lifecycle.PER_CLASS)
class ScheduledBattleServiceTest : BaseUniqueServiceTest<ScheduledBattle>() {

    override val classType: Class<ScheduledBattle> = ScheduledBattle::class.java

    @InjectMocks
    override lateinit var service: ScheduledBattleService

    @Mock
    override lateinit var repository: BaseUniqueRepository<ScheduledBattle>

    @Mock
    override lateinit var searchService: SearchService<ScheduledBattle>

    override val validId: UUID = UUID.randomUUID()
    override val invalidId: UUID = UUID.randomUUID() // ! Need method of failing

    @Mock
    override lateinit var validEntity: ScheduledBattle

    @Mock
    override lateinit var invalidEntity: ScheduledBattle

    @Mock
    override lateinit var replacedEntity: ScheduledBattle
    ...
    @Mock
    override lateinit var validPage: Page<ScheduledBattle>

    @Mock
    override lateinit var validEntities: List<ScheduledBattle>
    ...
    @Mock
    override lateinit var validSearchSpecification: Specification<ScheduledBattle>

    @Mock
    override lateinit var invalidSearchSpecification: Specification<ScheduledBattle>
