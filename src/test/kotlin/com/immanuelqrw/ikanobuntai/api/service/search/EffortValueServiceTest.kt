...
/**
 * Unit tests for EffortValueService
 */
@ExtendWith(SpringExtension::class)
@TestInstance(TestInstance.Lifecycle.PER_CLASS)
class EffortValueServiceTest : BaseUniqueServiceTest<EffortValue>() {

    override val classType: Class<EffortValue> = EffortValue::class.java

    @InjectMocks
    override lateinit var service: EffortValueService

    @Mock
    override lateinit var repository: BaseUniqueRepository<EffortValue>

    @Mock
    override lateinit var searchService: SearchService<EffortValue>

    override val validId: UUID = UUID.randomUUID()
    override val invalidId: UUID = UUID.randomUUID() // ! Need method of failing

    @Mock
    override lateinit var validEntity: EffortValue

    @Mock
    override lateinit var invalidEntity: EffortValue

    @Mock
    override lateinit var replacedEntity: EffortValue
    ...
    @Mock
    override lateinit var invalidSearchSpecification: Specification<EffortValue>
