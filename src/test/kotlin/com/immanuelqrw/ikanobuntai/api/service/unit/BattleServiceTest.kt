...
class BattleServiceTest : BaseUniqueServiceTest<Battle>() {
    ...
    @Mock
    override lateinit var searchService: SearchService<Battle>

    override val validId: UUID = UUID.randomUUID()
    override val invalidId: UUID = UUID.randomUUID() // ! Need method of failing

    @Mock
    override lateinit var validEntity: Battle

    @Mock
    override lateinit var invalidEntity: Battle

    @Mock
    override lateinit var replacedEntity: Battle
    ...
    @Mock
    override lateinit var validPage: Page<Battle>

    @Mock
    override lateinit var validEntities: List<Battle>
    ...
    @Mock
    override lateinit var validSearchSpecification: Specification<Battle>

    @Mock
    override lateinit var invalidSearchSpecification: Specification<Battle>
