...
/**
 * Unit tests for LeagueTrainerService
 */
@ExtendWith(SpringExtension::class)
@TestInstance(TestInstance.Lifecycle.PER_CLASS)
class LeagueTrainerServiceTest : BaseUniqueServiceTest<LeagueTrainer>() {

    override val classType: Class<LeagueTrainer> = LeagueTrainer::class.java

    @InjectMocks
    override lateinit var service: LeagueTrainerService

    @Mock
    override lateinit var repository: BaseUniqueRepository<LeagueTrainer>

    @Mock
    override lateinit var searchService: SearchService<LeagueTrainer>

    override val validId: UUID = UUID.randomUUID()
    override val invalidId: UUID = UUID.randomUUID() // ! Need method of failing

    @Mock
    override lateinit var validEntity: LeagueTrainer

    @Mock
    override lateinit var invalidEntity: LeagueTrainer

    @Mock
    override lateinit var replacedEntity: LeagueTrainer
    ...
    @Mock
    override lateinit var validPage: Page<LeagueTrainer>

    @Mock
    override lateinit var validEntities: List<LeagueTrainer>
    ...
    @Mock
    override lateinit var validSearchSpecification: Specification<LeagueTrainer>

    @Mock
    override lateinit var invalidSearchSpecification: Specification<LeagueTrainer>
