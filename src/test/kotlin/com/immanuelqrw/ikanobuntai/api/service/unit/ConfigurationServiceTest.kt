...
class ConfigurationServiceTest : BaseUniqueServiceTest<Configuration>() {

    override val classType: Class<Configuration> = Configuration::class.java

    @InjectMocks
    override lateinit var service: ConfigurationService

    @Mock
    override lateinit var repository: BaseUniqueRepository<Configuration>

    @Mock
    override lateinit var searchService: SearchService<Configuration>

    override val validId: UUID = UUID.randomUUID()
    override val invalidId: UUID = UUID.randomUUID() // ! Need method of failing

    @Mock
    override lateinit var validEntity: Configuration

    @Mock
    override lateinit var invalidEntity: Configuration

    @Mock
    override lateinit var replacedEntity: Configuration
    ...
    @Mock
    override lateinit var invalidSearchSpecification: Specification<Configuration>
