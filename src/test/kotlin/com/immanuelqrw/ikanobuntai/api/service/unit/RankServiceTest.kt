...
class RankServiceTest : BaseUniqueServiceTest<Rank>() {

    override val classType: Class<Rank> = Rank::class.java

    @InjectMocks
    override lateinit var service: RankService

    @Mock
    override lateinit var repository: BaseUniqueRepository<Rank>

    @Mock
    override lateinit var searchService: SearchService<Rank>

    override val validId: UUID = UUID.randomUUID()
    override val invalidId: UUID = UUID.randomUUID() // ! Need method of failing

    @Mock
    override lateinit var validEntity: Rank

    @Mock
    override lateinit var invalidEntity: Rank

    @Mock
    override lateinit var replacedEntity: Rank
    ...
    @Mock
    override lateinit var validPage: Page<Rank>

    override val validSearch: String = "id:$validId"
    override val invalidSearch: String = "id@$validId"

    @Mock
    override lateinit var validSearchSpecification: Specification<Rank>

    @Mock
    override lateinit var invalidSearchSpecification: Specification<Rank>
