...
/**
 * Unit tests for MoveService
 */
@ExtendWith(SpringExtension::class)
@TestInstance(TestInstance.Lifecycle.PER_CLASS)
class MoveServiceTest : BaseUniqueServiceTest<Move>() {

    override val classType: Class<Move> = Move::class.java

    @InjectMocks
    override lateinit var service: MoveService

    @Mock
    override lateinit var repository: BaseUniqueRepository<Move>

    @Mock
    override lateinit var searchService: SearchService<Move>

    override val validId: UUID = UUID.randomUUID()
    override val invalidId: UUID = UUID.randomUUID() // ! Need method of failing

    @Mock
    override lateinit var validEntity: Move

    @Mock
    override lateinit var invalidEntity: Move

    @Mock
    override lateinit var replacedEntity: Move
    ...
    @Mock
    override lateinit var validPage: Page<Move>

    @Mock
    override lateinit var validEntities: List<Move>
    ...
    @Mock
    override lateinit var validSearchSpecification: Specification<Move>

    @Mock
    override lateinit var invalidSearchSpecification: Specification<Move>
