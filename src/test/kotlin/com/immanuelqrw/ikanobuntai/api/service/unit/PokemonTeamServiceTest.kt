...
/**
 * Unit tests for PokemonTeamService
 */
@ExtendWith(SpringExtension::class)
@TestInstance(TestInstance.Lifecycle.PER_CLASS)
class PokemonTeamServiceTest : BaseUniqueServiceTest<PokemonTeam>() {

    override val classType: Class<PokemonTeam> = PokemonTeam::class.java

    @InjectMocks
    override lateinit var service: PokemonTeamService

    @Mock
    override lateinit var repository: BaseUniqueRepository<PokemonTeam>

    @Mock
    override lateinit var searchService: SearchService<PokemonTeam>

    override val validId: UUID = UUID.randomUUID()
    override val invalidId: UUID = UUID.randomUUID() // ! Need method of failing

    @Mock
    override lateinit var validEntity: PokemonTeam

    @Mock
    override lateinit var invalidEntity: PokemonTeam

    @Mock
    override lateinit var replacedEntity: PokemonTeam
    ...
    @Mock
    override lateinit var validPage: Page<PokemonTeam>

    @Mock
    override lateinit var validEntities: List<PokemonTeam>
    ...
    @Mock
    override lateinit var validSearchSpecification: Specification<PokemonTeam>

    @Mock
    override lateinit var invalidSearchSpecification: Specification<PokemonTeam>
